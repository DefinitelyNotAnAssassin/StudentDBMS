# Generated by Django 3.2.6 on 2022-07-17 07:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students', models.ManyToManyField(related_name='subjects', through='Student_Account.StudentGrade', to='Student_Account.StudentProfile')),
        ...
        migrations.AddField(
            ...
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Student_Account.studentprofile'),
        ),
        migrations.AddField(
            model_name='studentgrade',
            name='subject_teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Student_Account.subjectteacher'),
        ),
        migrations.AddField(
